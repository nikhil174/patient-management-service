...
public class PatientRequestDTO {
    ...
    @Size(max = 100, message = "Name cannot exceed 100 charactors")
    private String name;
    ...
    public @NotBlank(message = "Name is required") @Size(max = 100, message = "Name cannot exceed 100 charactors") String getName() {
        return name;
    }

    public void setName(@NotBlank(message = "Name is required") @Size(max = 100, message = "Name cannot exceed 100 charactors") String name) {
        this.name = name;
    }
